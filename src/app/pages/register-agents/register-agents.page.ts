...
@Component({
  selector: 'app-register-agents',
  templateUrl: './register-agents.page.html',
  styleUrls: ['./register-agents.page.scss'],
})
export class RegisterAgentsPage {
  form = new FormGroup({
    uid: new FormControl(''),
    ...
    role: new FormControl('agent'), // Aquí se establece el rol como 'agent'
